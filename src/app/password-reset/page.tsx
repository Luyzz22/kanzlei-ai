    ...
    <main className="flex min-h-[calc(100vh-200px)] items-center justify-center px-5 py-16">
      <div className="w-full max-w-[420px]">
        <div className="text-center">
          ...
          <p className="mt-2 text-[14px] text-gray-500">{sent ? "Prüfung erfolgreich. Falls ein Konto existiert, erhalten Sie eine E-Mail." : "Geben Sie Ihre E-Mail-Adresse ein, um einen Reset-Link zu erhalten."}</p>
        </div>
        ...
        {!sent ? (
          ...
          <div className="mt-8 rounded-2xl border border-emerald-200 bg-emerald-50 p-5 text-center">
            ...
            <p className="mt-1 text-[13px] text-emerald-700">Falls ein Konto mit <strong>{email}</strong> existiert, erhalten Sie in Kuerze eine E-Mail mit einem Link zur Passwortzurücksetzung.</p>
          </div>
        )}

        <div className="mt-6 space-y-3 text-center">
          <Link href="/login" className="block text-[14px] font-medium text-[#003856] hover:text-[#00507a]">← Zurück zum Login</Link>
