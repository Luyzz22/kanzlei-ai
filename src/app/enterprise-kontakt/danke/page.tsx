...
export const metadata: Metadata = { title: "Anfrage erhalten", description: "Vielen Dank für Ihre Enterprise-Anfrage." }
  ...
  return (
    <main className="flex min-h-[60vh] items-center justify-center px-5 py-20">
      <div className="w-full max-w-lg text-center">
        ...
        <h1 className="mt-5 text-[1.5rem] font-semibold tracking-tight text-gray-950">Vielen Dank für Ihre Anfrage</h1>
        <p className="mt-3 text-[15px] leading-relaxed text-gray-500">Wir haben Ihre Nachricht erhalten und melden uns innerhalb von 24 Stunden bei Ihnen. Für dringende Anfragen erreichen Sie uns direkt unter <Link href="mailto:ki@sbsdeutschland.de" className="font-medium text-[#003856]">ki@sbsdeutschland.de</Link>.</p>
        ...
        <div className="mt-8 rounded-2xl border border-gray-100 bg-gray-50 p-5">
          ...
          <div className="mt-4 space-y-3 text-left">
            {[
              { step: "1", text: "Wir prüfen Ihre Anfrage und bereiten eine individuelle Demo vor" },
              { step: "2", text: "Sie erhalten einen Terminvorschlag für ein 30-Min Erstgespraech" },
              { step: "3", text: "Im Gespraech klären wir Scope, Rollenmodell und Compliance-Kontext" },
              { step: "4", text: "Sie erhalten einen kostenlosen Pilot-Zugang für Ihr Team" },
            ].map((s) => (
