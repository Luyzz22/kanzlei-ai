...
export const metadata: Metadata = { title: "Produkt — Kernmodule", description: "KI-Vertragsanalyse mit Enterprise-Governance. Zehn Kernmodule und 16 Vertragstypen für juristische Teams." }
