...
export const metadata: Metadata = { title: "Vertragsdossier" }

export default function Page() {
  return (
    <div className="mx-auto max-w-5xl px-5 py-10 sm:px-8">
      <p className="text-[11px] font-semibold uppercase tracking-[0.15em] text-gold-700">📁 Administration</p>
      <h1 className="mt-2 text-[1.75rem] font-semibold tracking-tight text-gray-950">Vertragsdossier</h1>
      <p className="mt-2 text-[14px] text-gray-500">Alle Analysen, Kommentare und Nachweise zu diesem Vertrag.</p>
      <div className="mt-10 rounded-2xl border border-gray-200 bg-white p-12 text-center">
        <span className="text-[40px]">📁</span>
        <h2 className="mt-4 text-[17px] font-semibold text-gray-900">Dossier</h2>
