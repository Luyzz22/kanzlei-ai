...
const preise = [
  {
    name: "Starter",
    preis: "149€/Monat",
    details: "Bis zu 3 Nutzer, 50 Dokumente/Monat, E-Mail-Support."
  },
  {
    name: "Professional",
    preis: "299€/Monat",
    details: "Bis zu 10 Nutzer, unbegrenzte Dokumente, API-Zugang, Priority-Support."
  },
  {
    name: "Enterprise",
    preis: "699€/Monat",
    ...
    <main className="mx-auto max-w-6xl space-y-16 p-6">
      <section className="space-y-6 py-12 text-center">
        ...
        <p className="mx-auto max-w-2xl text-sm text-muted-foreground">
          Wichtiger Hinweis: Unsere KI liefert Unterstützung und Vorschläge, jedoch keine verbindliche Rechtsberatung.
          Die finale rechtliche Beurteilung und Verantwortung liegt stets bei der Kanzlei.
        </p>
        <div className="flex justify-center gap-3">
          ...
          <Button variant="outline" asChild>
            <Link href="/ki-transparenz">KI-Transparenz lesen</Link>
          </Button>
        </div>
      </section>
