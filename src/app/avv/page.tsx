    ...
    <main className="bg-[#FAFAF7]">
      <section className="py-20 sm:py-28">
        <div className="mx-auto max-w-3xl px-5 sm:px-8">
          ...
          <p className="mt-4 text-[14px] text-gray-500">gemäß Art. 28 DSGVO · Stand: April 2026</p>
          ...
          <div className="mt-10 space-y-8 text-[15px] leading-relaxed text-gray-600">
            ...
            <div>
              <h2 className="text-[17px] font-semibold text-gray-900">4. Technische und organisatorische Maßnahmen</h2>
            ...
            <div>
              ...
              <p className="mt-3">Der Verantwortliche ist für die Rechtmäßigkeit der Verarbeitung verantwortlich. Er erteilt alle Weisungen schriftlich oder in dokumentierter elektronischer Form. Der Auftragsverarbeiter unterstützt den Verantwortlichen bei der Erfüllung seiner Pflichten nach Art. 32-36 DSGVO.</p>
            </div>

            <div>
              <h2 className="text-[17px] font-semibold text-gray-900">7. Löschung und Rückgabe</h2>
              <p className="mt-3">Nach Beendigung des Auftrags werden alle personenbezogenen Daten gelöscht oder zurückgegeben, sofern keine gesetzliche Aufbewahrungspflicht besteht. Die Löschung wird dokumentiert und auf Anfrage bestätigt.</p>
            </div>

            <div>
              <h2 className="text-[17px] font-semibold text-gray-900">8. Kontrollrechte</h2>
              <p className="mt-3">Der Verantwortliche hat das Recht, die Einhaltung dieser Vereinbarung zu überprüfen. Dies kann durch Audits, Inspektionen oder die Anforderung von Nachweisen erfolgen.</p>
            </div>
          </div>
          ...
          <div className="mt-12 rounded-2xl border border-gold-200 bg-gold-50 p-6">
            ...
            <p className="mt-2 text-[13px] text-gray-600">Für eine unterschriftsreife AVV im PDF-Format kontaktieren Sie uns unter <Link href="mailto:ki@sbsdeutschland.de" className="font-medium text-[#003856]">ki@sbsdeutschland.de</Link>. Enterprise-Kunden erhalten eine individuell angepasste AVV.</p>
          </div>
        </div>
      </section>
    </main>
