...
export const metadata: Metadata = { title: "Für Rechtsabteilungen", description: "KI-Vertragsanalyse für Corporate Legal: Review-Workflows, Governance, Compliance und Lieferantenmanagement." }
    ...
    <main>
      <section className="bg-[#FAFAF7] py-20 sm:py-28">
        <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h1 className="text-display text-gray-950">KI-Vertragsanalyse für Corporate Legal</h1>
            <p className="mt-4 text-[17px] leading-relaxed text-gray-500">Strukturierte Review-Workflows, mehrstufige Freigaben und auditierbare Nachweise — für Rechtsabteilungen die Governance ernst nehmen.</p>
      ...
      <section className="py-20 sm:py-28">
        <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10">
          ...
          <div className="mt-10 grid gap-6 lg:grid-cols-2">
            {[
              { emoji: "📥", title: "Eingehende Verträge prüfen", desc: "Lieferantenverträge, NDAs und Rahmenverträge systematisch auf Risiken prüfen — bevor sie unterschrieben werden. Bilinguale Analyse (DE/EN).", features: ["Risiko-Score in < 3 Sekunden", "Procurement-Prüfpunkte automatisch", "Formulierungsvorschlaege für Nachverhandlung"] },
              ...
              { emoji: "📅", title: "Vertragsportfolio managen", desc: "Kündigungsfristen, Auto-Renewal und Vertragslaufzeiten im Blick behalten. Keine vergessenen Verlängerungen mehr.", features: ["Fristen-Ampel (rot/gelb/gruen)", "Lieferanten-Benchmarking", "Fälle & Mandate organisieren"] },
              { emoji: "✅", title: "Review & Governance", desc: "Mehrstufige Freigabeprozesse mit RBAC. Hochrisiko-Verträge landen automatisch in der Review-Queue.", features: ["4-Stage Pipeline (Eingereicht → Freigabe)", "Auto-Review bei Score >= 70", "Audit Trail für jede Entscheidung"] },
            ].map((uc) => (
      ...
      <section className="border-t border-gray-200 bg-gray-50 py-20 sm:py-28">
        <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10">
          ...
          <h2 className="mt-3 text-center text-display-sm text-gray-950">Für Ihre IT- und Compliance-Anforderungen</h2>
          <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[
              { emoji: "🔐", title: "SSO via Microsoft Entra", desc: "SAML/OIDC Single Sign-On für nahtlose Authentifizierung." },
      ...
      <section className="py-20 sm:py-28">
        <div className="mx-auto max-w-4xl px-5 text-center">
          ...
          <h2 className="mt-3 text-display-sm text-gray-950">Bereit für Ihre Rechtsabteilung?</h2>
