...
export default function Page() {
  return (
    <div className="mx-auto max-w-5xl px-5 py-10 sm:px-8">
      ...
      <h1 className="mt-2 text-[1.75rem] font-semibold tracking-tight text-gray-950">Aktivitäten</h1>
      <p className="mt-2 text-[14px] text-gray-500">Detaillierte Ansicht aller Audit-Events mit Filterung und Export.</p>
      <div className="mt-10 rounded-2xl border border-gray-200 bg-white p-12 text-center">
        <span className="text-[40px]">📊</span>
        <h2 className="mt-4 text-[17px] font-semibold text-gray-900">Aktivitätsprotokoll</h2>
