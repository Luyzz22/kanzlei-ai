...
export default function Page() {
  return (
    <div className="mx-auto max-w-5xl px-5 py-10 sm:px-8">
      ...
      <p className="mt-2 text-[14px] text-gray-500">KI-Prompt-Versionen, Release-Prozesse und Qualitätskontrolle.</p>
      <div className="mt-10 rounded-2xl border border-gray-200 bg-white p-12 text-center">
        <span className="text-[40px]">🤖</span>
        <h2 className="mt-4 text-[17px] font-semibold text-gray-900">KI-Steuerung</h2>
