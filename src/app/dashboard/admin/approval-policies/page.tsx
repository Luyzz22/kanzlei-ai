...
export default function ApprovalPoliciesPage() {
  return (
    <div className="mx-auto max-w-5xl px-5 py-10 sm:px-8">
      ...
      <p className="mt-2 text-[14px] text-gray-500">Mehrstufige Freigabe-Workflows für analysierte Verträge definieren.</p>
      ...
      <div className="mt-10 space-y-4">
        <div className="rounded-2xl border border-emerald-200 bg-emerald-50 p-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[13px] text-emerald-700">Verträge mit Risiko-Score ≥ 70 werden automatisch in die Review-Queue eingestellt und erfordern Freigabe durch einen Nutzer mit Rolle ANWALT oder ADMIN.</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid gap-3 sm:grid-cols-4">
          {[
            ...
            { step: "3", emoji: "👤", title: "Prüfung", desc: "Anwalt prüft Findings und Klauseln" },
        ...
        <div className="mt-4 rounded-xl border border-gray-100 bg-gray-50 p-4">
          <p className="text-[13px] text-gray-600">Individuelle Freigabe-Workflows mit mehrstufigen Genehmigungsketten, E-Mail-Benachrichtigungen und Eskalationsregeln sind für Enterprise-Kunden verfügbar. <Link href="/enterprise-kontakt" className="font-medium text-[#003856]">Kontakt aufnehmen →</Link></p>
        </div>
      </div>
