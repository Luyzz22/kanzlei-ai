...
const NDA_PROFILE: ContractTypeProfile = {
  ...
  marketStandardClauses: [
    ...
    { id: "non-solicitation", name: "Non-Solicitation (Mitarbeiter-Abwerbeverbot)", category: "should-have", description: "Schutz vor Abwerbung von Schluesselmitarbeitern waehrend und nach Verhandlungen.", fallbackTemplate: "Die Parteien verpflichten sich, waehrend der Laufzeit dieser Vereinbarung und für einen Zeitraum von zwoelf (12) Monaten danach keine Mitarbeiter der jeweils anderen Partei aktiv abzuwerben." },
