...
export const FALLBACK_CLAUSES: FallbackClause[] = [
  ...
  // =====================================================================
  {
    ...
    language: "de",
    text: `Die Gesamthaftung des Anbieters für alle Schäden aus oder in Zusammenhang mit diesem Vertrag, gleich aus welchem Rechtsgrund, ist auf einen Betrag in Höhe der vom Kunden in den letzten zwoelf (12) Monaten vor dem schadensauslosenden Ereignis tatsaechlich gezahlten Vertragsverguetung begrenzt. Diese Haftungsbegrenzung gilt nicht für Schäden aus Vorsatz oder grober Fahrlässigkeit, für Verletzungen von Leben, Koerper oder Gesundheit sowie für Anspruechen nach dem Produkthaftungsgesetz.`,
    citation: "BGB §§ 309 Nr. 7, 444; AGB-rechtskonform für B2B-Verträge",
    marketTier: "standard",
  },
  {
    ...
    language: "de",
    text: `Soweit der Anbieter im Rahmen der Leistungserbringung personenbezogene Daten im Auftrag des Kunden im Sinne von Art. 28 DSGVO verarbeitet, gilt der als Anlage X beigefuegte Auftragsverarbeitungsvertrag (AVV). Der AVV regelt insbesondere Gegenstand und Dauer der Verarbeitung, Art und Zweck der Verarbeitung, Art der personenbezogenen Daten, Kategorien betroffener Personen sowie die Rechte und Pflichten beider Parteien gemäß DSGVO Art. 28 Abs. 3.`,
  ...
  },
  {
    ...
    title: "Datenrueckgabe / Löschung nach Vertragsende",
    shortDesc: "Garantierte Datenextraktion und sichere Löschung",
    language: "de",
    text: `Nach Vertragsbeendigung stellt der Anbieter dem Kunden alle gespeicherten Daten in einem strukturierten, gaengigen und maschinenlesbaren Format (z.B. CSV, JSON, XML) für einen Zeitraum von dreissig (30) Tagen zum Export bereit. Nach Ablauf dieser Frist loescht der Anbieter alle Kundendaten unwiderruflich, einschliesslich aller Backups, innerhalb von neunzig (90) Tagen. Der Anbieter bestätigt die vollstaendige Löschung schriftlich gegenüber dem Kunden.`,
    citation: "DSGVO Art. 17, 20; Marktstandard für Enterprise-SaaS",
    marketTier: "standard",
  },
  {
    ...
    language: "de",
    text: `Der Anbieter verarbeitet und speichert alle personenbezogenen Daten des Kunden ausschließlich auf Servern innerhalb der Europäischen Union oder des Europäischen Wirtschaftsraums. Sollte im Einzelfall ein Transfer in ein Drittland erforderlich werden, geschieht dies ausschließlich auf Basis der Standardvertragsklauseln (SCCs) der Europäischen Kommission gemäß Durchfuehrungsbeschluss (EU) 2021/914 in der jeweils aktuellen Fassung sowie unter Implementierung geeigneter zusätzlicher Schutzmassnahmen gemäß EuGH-Urteil "Schrems II".`,
  ...
  },
  {
    ...
    title: "Service Level Agreement (Verfügbarkeit)",
    shortDesc: "99,5% Verfügbarkeit mit Service-Credits",
    language: "de",
    text: `Der Anbieter garantiert eine monatliche Verfügbarkeit der Software von mindestens 99,5% (gemessen pro Kalendermonat, exklusive geplanter Wartungsfenster und höherer Gewalt). Bei Unterschreitung erhält der Kunde Service-Credits in folgender Höhe: bei 99,0% bis 99,49% Verfügbarkeit 10% der Monatsvergütung, bei 95,0% bis 98,99% Verfügbarkeit 25% der Monatsvergütung, unter 95,0% Verfügbarkeit 50% der Monatsvergütung. Geplante Wartungsfenster werden mindestens 48 Stunden im Voraus angekündigt und außerhalb der Geschäftszeiten (08:00-20:00 MEZ) durchgeführt.`,
    citation: "Marktstandard für Business-Tier SaaS; vergleichbar AWS/Azure",
    marketTier: "standard",
  },
  ...
  // =====================================================================
  {
    ...
    language: "de",
    text: `Der Auftragsverarbeiter trifft technische und organisatorische Maßnahmen zur Gewährleistung eines dem Risiko angemessenen Schutzniveaus gemäß Art. 32 DSGVO. Diese Maßnahmen umfassen insbesondere: (a) Pseudonymisierung und Verschlüsselung personenbezogener Daten (mindestens TLS 1.3 für Transport, AES-256 für Speicherung), (b) Sicherstellung der Vertraulichkeit, Integritaet, Verfügbarkeit und Belastbarkeit der Verarbeitungssysteme auf Dauer, (c) Wiederherstellbarkeit nach physischen oder technischen Zwischenfaellen, (d) Verfahren zur regelmaessigen Ueberprüfung, Bewertung und Evaluierung der Wirksamkeit. Die im Detail umgesetzten Maßnahmen sind in Anlage Y dokumentiert und werden mindestens jährlich aktualisiert.`,
  ...
  },
  {
    ...
    shortDesc: "24-Stunden-Frist für Breach-Notifications",
    language: "de",
    text: `Der Auftragsverarbeiter informiert den Verantwortlichen unverzueglich, spaetestens jedoch innerhalb von vierundzwanzig (24) Stunden nach Kenntniserlangung, über jede Verletzung des Schutzes personenbezogener Daten im Sinne von Art. 4 Nr. 12 DSGVO. Die Meldung enthaelt mindestens: (a) eine Beschreibung der Art der Verletzung, (b) die betroffenen Datenkategorien und Anzahl der Betroffenen, (c) wahrscheinliche Folgen, (d) ergriffene oder geplante Maßnahmen zur Eindaemmung. Der Auftragsverarbeiter unterstützt den Verantwortlichen bei dessen Meldepflichten gemäß Art. 33, 34 DSGVO.`,
