...
export const FALLBACK_CLAUSES: FallbackClause[] = [
  ...
  },
  {
    ...
    language: "de",
    text: `Der Anbieter garantiert eine monatliche Verfügbarkeit der Software von mindestens 99,5% (gemessen pro Kalendermonat, exklusive geplanter Wartungsfenster und hoeherer Gewalt). Bei Unterschreitung erhaelt der Kunde Service-Credits in folgender Hoehe: bei 99,0% bis 99,49% Verfügbarkeit 10% der Monatsverguetung, bei 95,0% bis 98,99% Verfügbarkeit 25% der Monatsverguetung, unter 95,0% Verfügbarkeit 50% der Monatsverguetung. Geplante Wartungsfenster werden mindestens 48 Stunden im Voraus angekündigt und ausserhalb der Geschaeftszeiten (08:00-20:00 MEZ) durchgeführt.`,
  ...
  // =====================================================================
  {
    ...
    language: "de",
    text: `Der Auftragsverarbeiter trifft technische und organisatorische Maßnahmen zur Gewährleistung eines dem Risiko angemessenen Schutzniveaus gemäß Art. 32 DSGVO. Diese Maßnahmen umfassen insbesondere: (a) Pseudonymisierung und Verschlüsselung personenbezogener Daten (mindestens TLS 1.3 für Transport, AES-256 für Speicherung), (b) Sicherstellung der Vertraulichkeit, Integritaet, Verfügbarkeit und Belastbarkeit der Verarbeitungssysteme auf Dauer, (c) Wiederherstellbarkeit nach physischen oder technischen Zwischenfaellen, (d) Verfahren zur regelmaessigen Ueberprüfung, Bewertung und Evaluierung der Wirksamkeit. Die im Detail umgesetzten Maßnahmen sind in Anlage Y dokumentiert und werden mindestens jaehrlich aktualisiert.`,
