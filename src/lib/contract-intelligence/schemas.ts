...
export const SAAS_SCHEMA: ContractTypeSchema = {
  ...
  fields: [
    ...
    { key: "auto_renewal", label: "Automatische Verlängerung", shortLabel: "Auto-Renewal", applicability: "required", category: "term", description: "Automatic renewal terms", marketStandard: "12 months with 90 day opt-out" },
    { key: "notice_period", label: "Kündigungsfrist", shortLabel: "Notice Period", applicability: "required", category: "termination", description: "Required notice for termination", marketStandard: "90 days before renewal" },
...
export const AVV_SCHEMA: ContractTypeSchema = {
  ...
  fields: [
    ...
    { key: "tom_measures", label: "Technische und organisatorische Maßnahmen (TOM)", shortLabel: "TOMs", applicability: "required", category: "data_protection", description: "DSGVO Art. 32" },
    ...
    { key: "audit_rights", label: "Prüfrechte", shortLabel: "Audit", applicability: "required", category: "data_protection", description: "DSGVO Art. 28 Abs. 3 lit. h" },
    { key: "data_deletion", label: "Löschung / Rückgabe", shortLabel: "Löschung", applicability: "required", category: "data_protection", description: "Nach Vertragsende" },
  ...
  recommendedClauses: [
    "Standard Contractual Clauses (SCCs) für Drittlandtransfer",
